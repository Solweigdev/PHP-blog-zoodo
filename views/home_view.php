        ...
        <div class="col-md-6">
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                <div class="card-body d-flex flex-column align-items-start">
                    ...
                    <div class="mb-1 text-muted"><?= date_format(date_create($lastArticleLeft['date']), "d/m/Y H:i") ?></div>
                    <p class="card-text mb-auto"><?= $lastArticleLeft['sentence'] ?></p>
                    <a href="#">Lire la suite</a>
                </div>
                <img class="card-img-right flex-auto d-none d-lg-block" src="../assets/img/index.svg" alt="Card image cap">
            </div>
        </div>
        <div class="col-md-6">
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                <div class="card-body d-flex flex-column align-items-start">
                    ...
                    <div class="mb-1 text-muted"><?= date_format(date_create($lastArticleRight['date']), "d/m/Y H:i") ?></div>
    ...
    <div class="row">
        <div class="col-md-8 blog-main">
            ...
            <nav class="blog-pagination">
                <a class="btn btn-outline-primary" href="#">Ancien</a>
                <a class="btn btn-outline-secondary disabled" href="#">Nouveau</a>
            </nav>
